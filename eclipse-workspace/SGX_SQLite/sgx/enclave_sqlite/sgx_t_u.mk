...
ifeq ($(SGX_ARCH), x86)
	...
	SGX_LIBRARY_PATH := /opt/intel/sgxsdk/lib # SGX library path
	SGX_ENCLAVE_SIGNER := /opt/intel/sgxsdk/bin/x86/sgx_sign # Tool for signing enclaves
	SGX_EDGER8R := /opt/intel/sgxsdk/bin/x86/sgx_edger8r # Tool to create bridge routines
else
...
App_Include_Paths := -IApp -I/opt/intel/sgxsdk/include
...
App/Enclave_u.c: $(SGX_EDGER8R) Enclave/Enclave.edl
	cd App && $(SGX_EDGER8R) --untrusted ../Enclave/Enclave.edl --search-path ../Enclave --search-path /opt/intel/sgxsdk/include
	@echo "GEN  =>  $@"
...
Enclave/ocall_interface.i: Enclave/ocall_interface.c
	$(CC) -I/opt/intel/sgxsdk/include -E $< -o $@
	@echo "CC-Preprocess  <=  $<"
